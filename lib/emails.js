...
export function buildNudgeEmail({ taskTitle, stepsRemaining, taskId }) {
    ...
    <tr>
      <td style="padding:32px;">
        ...
        <p style="margin:0 0 24px 0;font-size:16px;color:#94a3b8;line-height:1.5;">
          Your task <strong style="color:#e2e8f0;">"${safeTitle}"</strong> is still in progress.
        ...
        <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:28px;">
          <tr>
            <td style="background-color:#0f172a;border-radius:10px;padding:16px 20px;">
              ...
              <p style="margin:4px 0 0 0;font-size:13px;color:#64748b;">${safeTitle}</p>
            </td>
          </tr>
        </table>
  ...
  return {
    subject: safeSubject(`You've got ${stepsRemaining} ${stepsWord} left on "${taskTitle}"`),
